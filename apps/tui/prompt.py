...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        (
            ...
            CommandSpec("agent", "Agent Markdown 管理面板"),
    ...
    CommandSpec(
        "/agent",
        "管理 Agent Markdown 与学习状态",
        (
            CommandSpec("list", "列出 Agent Markdown"),
            CommandSpec("view", "查看 Agent 指令，如 /agent view analyst"),
            CommandSpec("edit", "打开/提示编辑 Agent Markdown"),
            CommandSpec("backup", "创建 Agent Markdown 备份"),
            CommandSpec("learning", "学习状态/建议/触发二级菜单"),
            CommandSpec("stats", "等价于 /agent learning stats"),
            CommandSpec("suggestions", "等价于 /agent learning suggestions"),
            CommandSpec("trigger", "等价于 /agent learning trigger"),
        ),
    ),
